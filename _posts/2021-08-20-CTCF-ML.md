...
<br/>
{% include button.html text="Donwload MATLAB App" link="/files/other/v0.1.1.mlappinstall" color="#f68140" %} {% include button.html text="Donwload DCNN Model" link="https://github.com/where-is-brett/cell-fluorescence-ml/raw/main/model-96.h5" color="#0d94e7" %}