...
<br>
AI Bassist is a symbolic model that generates monophonic bass melodies in the style of minimal house and techno music. You can play with it <a href="/groove-box.html">on this page</a>. The targeted destination for generated content is a software synthesiser which interprets MIDI files. Human interaction is possible during content generation via a SoftMax temperature parameter[^2], though it is not reflected in the user interface (UI) in the current release. 

Access to music instruments and musical knowledge are the main obstacles to novice producers when it comes to composing a bassline. AI Bassist serves as a groove box so that one can focus on sound design and arrangement. AI Bassist generates 2-bar basslines in the form of a MIDI file, which is readily processed by a software synthesiser to produce all kinds of sound. Below is a demo track containing two generated melodies.
<br>
...
<br>
Two generated MIDI containing note sequences were processed by Roland synthesisers TB-303 and Jupiter-8. The 303 gave sets the acidic scene and the arpeggiated Jupiter-8 adds occasional polyphony. Drum track was built from audio samples.

<figure>
  <img src="/files/images/AI-Bassist-Demo-1.jpg" alt="Logic X Pro" style="width:100%">
  <figcaption>Figure 1. A snapshot of the digital audio workstation (DAW)</figcaption>
</figure>
